...
function bmrt_test_benchmark(){
    ...
    if test $TARGET = "BM1684"; then
      bmrt_test_case BM1684/yolov11s_fp32_1b.bmodel
      bmrt_test_case BM1684/yolov11s_int8_1b.bmodel
      bmrt_test_case BM1684/yolov11s_int8_4b.bmodel
      bmrt_test_case BM1684/yolov11s_opt_fp32_1b.bmodel
      bmrt_test_case BM1684/yolov11s_opt_int8_1b.bmodel
      bmrt_test_case BM1684/yolov11s_opt_int8_4b.bmodel
    elif test $TARGET = "BM1684X"; then
      bmrt_test_case BM1684X/yolov11s_fp32_1b.bmodel
      bmrt_test_case BM1684X/yolov11s_fp16_1b.bmodel
      bmrt_test_case BM1684X/yolov11s_int8_1b.bmodel
      bmrt_test_case BM1684X/yolov11s_int8_4b.bmodel
      bmrt_test_case BM1684X/yolov11s_opt_fp32_1b.bmodel
      bmrt_test_case BM1684X/yolov11s_opt_fp16_1b.bmodel
      bmrt_test_case BM1684X/yolov11s_opt_int8_1b.bmodel
      bmrt_test_case BM1684X/yolov11s_opt_int8_4b.bmodel
    elif test $TARGET = "BM1688"; then
      bmrt_test_case BM1688/yolov11s_fp32_1b.bmodel
      bmrt_test_case BM1688/yolov11s_fp16_1b.bmodel
      bmrt_test_case BM1688/yolov11s_int8_1b.bmodel
      bmrt_test_case BM1688/yolov11s_int8_4b.bmodel
      bmrt_test_case BM1688/yolov11s_fp32_1b_2core.bmodel
      bmrt_test_case BM1688/yolov11s_fp16_1b_2core.bmodel
      bmrt_test_case BM1688/yolov11s_int8_1b_2core.bmodel
      bmrt_test_case BM1688/yolov11s_int8_4b_2core.bmodel
      bmrt_test_case BM1688/yolov11s_opt_fp32_1b.bmodel
      bmrt_test_case BM1688/yolov11s_opt_fp16_1b.bmodel
      bmrt_test_case BM1688/yolov11s_opt_int8_1b.bmodel
      bmrt_test_case BM1688/yolov11s_opt_int8_4b.bmodel
      bmrt_test_case BM1688/yolov11s_opt_fp32_1b_2core.bmodel
      bmrt_test_case BM1688/yolov11s_opt_fp16_1b_2core.bmodel
      bmrt_test_case BM1688/yolov11s_opt_int8_1b_2core.bmodel
      bmrt_test_case BM1688/yolov11s_opt_int8_4b_2core.bmodel
    elif test $TARGET = "CV186X"; then
      bmrt_test_case CV186X/yolov11s_fp32_1b.bmodel
      bmrt_test_case CV186X/yolov11s_fp16_1b.bmodel
      bmrt_test_case CV186X/yolov11s_int8_1b.bmodel
      bmrt_test_case CV186X/yolov11s_int8_4b.bmodel
      bmrt_test_case CV186X/yolov11s_opt_fp32_1b.bmodel
      bmrt_test_case CV186X/yolov11s_opt_fp16_1b.bmodel
      bmrt_test_case CV186X/yolov11s_opt_int8_1b.bmodel
      bmrt_test_case CV186X/yolov11s_opt_int8_4b.bmodel
...
function build_pcie()
{
  pushd cpp/yolov11_$1
  if [ -d build ]; then
      rm -rf build
  fi
  mkdir build && cd build
  cmake .. && make
  judge_ret $? "build yolov11_$1" 0
  popd
}
...
function build_soc()
{
  ...
  judge_ret $? "build soc yolov11_$1" 0
  popd
}
...
function test_python()
{
  ...
  python3 python/yolov11_$1.py --input $3 --bmodel models/$TARGET/$2 --dev_id $TPUID > log/$1_$2_python_test.log 2>&1
  judge_ret $? "python3 python/yolov11_$1.py --input $3 --bmodel models/$TARGET/$2 --dev_id $TPUID" log/$1_$2_python_test.log
  
  tail -n 20 log/$1_$2_python_test.log
  if test $3 = "datasets/coco/val2017_1000"; then
    echo "==================="
    echo "Comparing statis..."
    python3 tools/compare_statis.py --target=$TARGET --platform=${MODE%_*} --program=yolov11_$1.py --language=python --input=log/$1_$2_python_test.log --bmodel=$2
    judge_ret $? "python3 tools/compare_statis.py --target=$TARGET --platform=${MODE%_*} --program=yolov11_$1.py --language=python --input=log/$1_$2_python_test.log --bmodel=$2"
    echo "==================="
  fi
}
...
{ 
  ...
  python3 python/yolov11_$1.py --input datasets/coco/val2017_1000 --bmodel models/$TARGET/$2 --dev_id $TPUID --conf_thresh 0.001 --nms_thresh 0.7 > python/log/$1_$2_debug.log 2>&1
  judge_ret $? "python3 python/yolov11_$1.py --input datasets/coco/val2017_1000 --bmodel models/$TARGET/$2 --dev_id $TPUID --conf_thresh 0.001 --nms_thresh 0.7 > python/log/$1_$2_debug.log 2>&1" python/log/$1_$2_debug.log
  ...
  printf "| %-12s | %-14s | %-22s | %8.3f | %8.3f |\n" "$PLATFORM" "yolov11_$1.py" "$2" "$(printf "%.3f" $ap0)" "$(printf "%.3f" $ap1)" >> scripts/acc.txt
  echo -e "########################\nCase End: eval python\n########################\n"
}

function test_cpp()
{
  pushd cpp/yolov11_$2
  if [ ! -d log ];then
    mkdir log
  fi
  ./yolov11_$2.$1 --input=$4 --bmodel=../../models/$TARGET/$3 --dev_id=$TPUID > log/$1_$2_$3_cpp_test.log 2>&1
  judge_ret $? "./yolov11_$2.$1 --input=$4 --bmodel=../../models/$TARGET/$3 --dev_id=$TPUID" log/$1_$2_$3_cpp_test.log
  
  tail -n 15 log/$1_$2_$3_cpp_test.log
  if test $4 = "../../datasets/coco/val2017_1000"; then
    echo "==================="
    echo "Comparing statis..."
    python3 ../../tools/compare_statis.py --target=$TARGET --platform=${MODE%_*} --program=yolov11_$2.$1 --language=cpp --input=log/$1_$2_$3_cpp_test.log --bmodel=$3
    judge_ret $? "python3 ../../tools/compare_statis.py --target=$TARGET --platform=${MODE%_*} --program=yolov11_$2.$1 --language=cpp --input=log/$1_$2_$3_cpp_test.log --bmodel=$3"
    echo "==================="
  fi
...
function eval_cpp()
{
  ...
  ./yolov11_$2.$1 --input=../../datasets/coco/val2017_1000 --bmodel=../../models/$TARGET/$3 --conf_thresh=0.001 --nms_thresh=0.7  --dev_id=$TPUID > log/$1_$2_$3_debug.log 2>&1
  judge_ret $? "./yolov11_$2.$1 --input=../../datasets/coco/val2017_1000 --bmodel=../../models/$TARGET/$3 --conf_thresh=0.001 --nms_thresh=0.7  --dev_id=$TPUID > log/$1_$2_$3_debug.log 2>&1" log/$1_$2_$3_debug.log
  ...
  ap0=$(echo -e "$res"| grep "Average Precision  (AP) @\[ IoU\=0.50:0.95 | area\=   all | maxDets\=100 \]" | grep -oP ' = \K\d+\.\d+' | awk '{printf "%.3f \n", $1}')
  ap1=$(echo -e "$res"| grep "Average Precision  (AP) @\[ IoU\=0.50      | area\=   all | maxDets\=100 \]" | grep -oP ' = \K\d+\.\d+' | awk '{printf "%.3f \n", $1}')
  printf "| %-12s | %-14s | %-22s | %8.3f | %8.3f |\n" "$PLATFORM" "yolov11_$2.$1" "$3" "$(printf "%.3f" $ap0)" "$(printf "%.3f" $ap1)" >> ../../scripts/acc.txt
...
then
  ...
  then
    ...
    test_python opencv yolov11s_int8_1b.bmodel datasets/test_car_person_1080P.mp4
    test_python opencv yolov11s_int8_4b.bmodel datasets/test_car_person_1080P.mp4
    test_python bmcv yolov11s_fp32_1b.bmodel datasets/test_car_person_1080P.mp4
    test_python bmcv yolov11s_int8_1b.bmodel datasets/test_car_person_1080P.mp4
    test_python bmcv yolov11s_int8_4b.bmodel datasets/test_car_person_1080P.mp4
    test_cpp pcie bmcv yolov11s_fp32_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp pcie bmcv yolov11s_int8_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp pcie bmcv yolov11s_int8_4b.bmodel ../../datasets/test_car_person_1080P.mp4

    #performence test
    test_python opencv yolov11s_fp32_1b.bmodel datasets/coco/val2017_1000
    test_python opencv yolov11s_int8_1b.bmodel datasets/coco/val2017_1000
    test_python opencv yolov11s_int8_4b.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_fp32_1b.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_int8_1b.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_int8_4b.bmodel datasets/coco/val2017_1000
    test_cpp pcie bmcv yolov11s_fp32_1b.bmodel ../../datasets/coco/val2017_1000
  ...
  then
    ...
    test_python opencv yolov11s_int8_4b.bmodel datasets/test_car_person_1080P.mp4
    test_python bmcv yolov11s_fp32_1b.bmodel datasets/test_car_person_1080P.mp4
    test_python bmcv yolov11s_fp16_1b.bmodel datasets/test_car_person_1080P.mp4
    test_python bmcv yolov11s_int8_1b.bmodel datasets/test_car_person_1080P.mp4
    test_python bmcv yolov11s_int8_4b.bmodel datasets/test_car_person_1080P.mp4
    test_cpp pcie bmcv yolov11s_fp32_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp pcie bmcv yolov11s_fp16_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp pcie bmcv yolov11s_int8_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp pcie bmcv yolov11s_int8_4b.bmodel ../../datasets/test_car_person_1080P.mp4

    #performence test
    test_python opencv yolov11s_fp32_1b.bmodel datasets/coco/val2017_1000
    test_python opencv yolov11s_fp16_1b.bmodel datasets/coco/val2017_1000
    test_python opencv yolov11s_int8_1b.bmodel datasets/coco/val2017_1000
    test_python opencv yolov11s_int8_4b.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_fp32_1b.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_fp16_1b.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_int8_1b.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_int8_4b.bmodel datasets/coco/val2017_1000
    test_cpp pcie bmcv yolov11s_fp32_1b.bmodel ../../datasets/coco/val2017_1000
    test_cpp pcie bmcv yolov11s_fp16_1b.bmodel ../../datasets/coco/val2017_1000
    test_cpp pcie bmcv yolov11s_int8_1b.bmodel ../../datasets/coco/val2017_1000
    test_cpp pcie bmcv yolov11s_int8_4b.bmodel ../../datasets/coco/val2017_1000
    ...
    test_cpp pcie bmcv yolov11s_opt_fp32_1b.bmodel ../../datasets/coco/val2017_1000
    test_cpp pcie bmcv yolov11s_opt_fp16_1b.bmodel ../../datasets/coco/val2017_1000
    test_cpp pcie bmcv yolov11s_opt_int8_1b.bmodel ../../datasets/coco/val2017_1000
...
then
  ...
  then
    ...
    test_python bmcv yolov11s_int8_1b.bmodel datasets/test_car_person_1080P.mp4
    test_python bmcv yolov11s_int8_4b.bmodel datasets/test_car_person_1080P.mp4
    test_cpp soc bmcv yolov11s_fp32_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp soc bmcv yolov11s_int8_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp soc bmcv yolov11s_int8_4b.bmodel ../../datasets/test_car_person_1080P.mp4
    ...
    test_python bmcv yolov11s_int8_1b.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_int8_4b.bmodel datasets/coco/val2017_1000
    test_cpp soc bmcv yolov11s_fp32_1b.bmodel ../../datasets/coco/val2017_1000
  ...
  then
    ...
    test_python bmcv yolov11s_int8_4b.bmodel datasets/test_car_person_1080P.mp4
    test_cpp soc bmcv yolov11s_fp32_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp soc bmcv yolov11s_fp16_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp soc bmcv yolov11s_int8_1b.bmodel ../../datasets/test_car_person_1080P.mp4
    test_cpp soc bmcv yolov11s_int8_4b.bmodel ../../datasets/test_car_person_1080P.mp4
    ...
    test_python bmcv yolov11s_int8_4b.bmodel datasets/coco/val2017_1000
    test_cpp soc bmcv yolov11s_fp32_1b.bmodel ../../datasets/coco/val2017_1000
    test_cpp soc bmcv yolov11s_fp16_1b.bmodel ../../datasets/coco/val2017_1000
    test_cpp soc bmcv yolov11s_int8_1b.bmodel ../../datasets/coco/val2017_1000
    test_cpp soc bmcv yolov11s_int8_4b.bmodel ../../datasets/coco/val2017_1000
  ...
  then
    ...
    test_python opencv yolov11s_fp16_1b_2core.bmodel datasets/coco/val2017_1000
    test_python opencv yolov11s_int8_1b_2core.bmodel datasets/coco/val2017_1000
    test_python opencv yolov11s_int8_4b_2core.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_fp32_1b_2core.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_fp16_1b_2core.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_int8_1b_2core.bmodel datasets/coco/val2017_1000
    test_python bmcv yolov11s_int8_4b_2core.bmodel datasets/coco/val2017_1000
    test_cpp soc bmcv yolov11s_fp32_1b_2core.bmodel ../../datasets/coco/val2017_1000
    test_cpp soc bmcv yolov11s_fp16_1b_2core.bmodel ../../datasets/coco/val2017_1000
    test_cpp soc bmcv yolov11s_int8_1b_2core.bmodel ../../datasets/coco/val2017_1000
    ...
    test_cpp soc bmcv yolov11s_opt_int8_1b_2core.bmodel ../../datasets/coco/val2017_1000
    test_cpp soc bmcv yolov11s_opt_int8_4b_2core.bmodel ../../datasets/coco/val2017_1000
...
if [ x$MODE == x"pcie_test" ] || [ x$MODE == x"soc_test" ]; then
  echo "--------yolov11_det mAP----------"
  cat scripts/acc.txt
  echo "--------bmrt_test performance-----------"
  bmrt_test_benchmark
  echo "--------yolov11_det performance-----------"
